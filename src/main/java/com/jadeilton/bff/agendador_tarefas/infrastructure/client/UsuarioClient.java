...
public interface UsuarioClient {
    ...
    @PostMapping
    UsuarioDTORequest salvarUsuario(@RequestBody UsuarioDTORequest usuarioDTO);
    ...
    EnderecoDTOResponse cadastroEndereco(@RequestBody EnderecoDTORequest dto, @RequestHeader ("Authorization") String token);

    @PostMapping("/telefone")
    TelefoneDTOResponse cadastroTelefone(@RequestBody TelefoneDTORequest dto, @RequestHeader("Authorization") String token, @PathVariable("id")Long idTelefone);
